      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-3 gap-4 md:gap-8 max-w-2xl mx-auto mb-16">
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="text-center p-4 md:p-6 bg-secondary-foreground/5 rounded-2xl border border-secondary-foreground/10"
            >
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-gradient-to-br from-primary/20 to-primary/5 rounded-3xl p-8 md:p-10 border border-primary/30 relative overflow-hidden">
            {/* Trophy badge */}
